...
It is a requirement that the CCS provide a compliant implementation of the
...
The requirement for the ability to run in either Primary mode or Shadow mode
